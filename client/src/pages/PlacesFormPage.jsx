    ...
    return (
     <div>
        ...
        <form onSubmit={savePlace}>
                        ...
                        <input type="text" placeholder='title , for ex: my lovely apartment' value={title} onChange={ev => setTitle(ev.target.value)} />
                        ...
                        <textarea className='h-16' value={description} onChange={ev => setDescription(ev.target.value)} />

                        {preInput('Perks', 'select all the perks underneath it')}
                        <Perks selected={perks} onChange={setPerks} />

                        {preInput('Extra Info', 'house rules , etc')}
                        <textarea className='h-16' value={extraInfo} onChange={ev => setExtraInfo(ev.target.value)} />

                        {preInput('check-in&out times , max-guests', 'add check-in check-out time times , remember to have some time window for cleaning the room between guests')}
                        ...
                        <div className='grid grid-cols-2 md:grid-cols-4 gap-2'>
                            ...
                            <div>
                                ...
                                <input type="text" placeholder='18:00' value={checkOut} onChange={ev => setCheckOut(ev.target.value)} />
                            </div>
                            <div>
